...
DrawNewVerticalTiles:
    ...
    ld a, [BgScrollYLsbDiv8VertTileUpdate]
    dec a
    and %11111
    ld c, 0
...
:   pop af
    and $80
    jr nz, .DrawColumnLeft
    ld a, [BgScrollXLsbDiv8VertTileUpdate]
    add $14
    jr .HaveColumnX
...
REPT 20
 :  ldh a, [rSTAT]
    ...
    ld a, [de]
    inc e
    ld [hl], a                  ; Write into background tile index map (Tile X).
...
DrawNewHorizontalTiles:
    ld a, [NeedNewYTile]
    or a
    ret z                           ; Return if now new tile is needed.
    push af
    ld h, HIGH(_SCRN0)
    ld a, [BgScrollXLsbDiv8HorizTileUpdate]
    dec a
    and %11111
    ld l, a
    pop af
...
; Funny: As ASCII, this data spells "Samaua".
LianaPositionPtrs::
...
; Boss animnation data.
; 4-tuples constructed as follows:
; data[0]: Sets NumObjSpriteIndex
; data[1]: Sets obj[ATR_PERIOD_TIMER0]
; data[2]: Sets BossAnimation1
; data[3]: Sets BossAnimation2
