...
; $4000: Initializes the data in c400.
TODOFunc6400::
    ld de, $c400
TODOLoop:
    ld a, [hl+]                 ; Points to TODOPtrBase401d.
    bit 7, a
    jr nz, jr_006_400d
    ld [de], a                  ; Cpoy data to [$c400+e]
    inc e
    jr nz, TODOLoop             ; Loops up to 256 times.
    ret
jr_006_400d:
    and $7f
    jr nz, :+
...
; $401d: This should be pointer data. The referred data is somehow related to the ground's hitbox.
GroundDataPtrBase::
